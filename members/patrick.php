...
<link rel="stylesheet" href="/website/css/member-info.css">
    ...
    <main>
        <img src="/website/images/members/patrick.jpeg" alt="">
          ...
          <div class="parent">
            ...
            <div class="child-animation">
              <div class="child child-github">
                <a class="button btn-github" href="https://github.com/preeson" target="_blank">
              ...
              <div class="user">preeson</div>
            </div>
            

            <div class="child-animation">
              <div class="child child-gmail">
                <a class="button btn-gmail" href="mailto:reesonpatrick@gmail.com" target="_blank">
              ...
              <div class="user">reesonpatrick@gmail.com</div>
            </div>
            

            <div class="child-animation">
              <div class="child child-cnrs">
                <a class="button btn-cnrs" href="mailto:patrick.reeson@cnrs.fr" target="_blank">
              ...
              <div class="user">patrick.reeson@cnrs.fr</div>
            </div>

            <div class="child-animation">
              <div class="child child-scholar">
                <a class="button btn-scholar" href="https://scholar.google.com/citations?hl=fr&user=LwNk3OUAAAAJ" target="_blank">
              ...
              <div class="user">Patrick Reeson</div>
            </div>
