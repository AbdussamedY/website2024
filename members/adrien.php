...
<link rel="stylesheet" href="/website/css/member-info.css">
    ...
    <main>
        <img src="/website/images/members/adrien.jpeg" alt="">
          ...
          <div class="parent">
            ...
            <div class="child-animation">
              <div class="child child-github">
                <a class="button btn-github" href="https://github.com/abarralis" target="_blank">
              ...
              <div class="user">abarralis</div>
            </div>
            

            <div class="child-animation">
              <div class="child child-cnrs">
                <a class="button btn-cnrs" href="mailto:adrien.barralis@cnrs.fr" target="_blank">
              ...
              <div class="user">adrien.barralis@cnrs.fr</div>
            </div>
