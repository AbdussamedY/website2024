<?php include $_SERVER['DOCUMENT_ROOT'] . '/website/common/header.php';?>
    ...
    <main>
        <img src="/website/images/members/auguste.jpeg" alt="">
          ...
          <div class="parent">
            ...
            <div class="child-animation">
              <div class="child child-cnrs">
                <a class="button btn-cnrs" href="mailto:auguste.pouchelle@cnrs.fr" target="_blank">
              ...
              <div class="user">auguste.pouchelle@cnrs.fr</div>
            </div>
